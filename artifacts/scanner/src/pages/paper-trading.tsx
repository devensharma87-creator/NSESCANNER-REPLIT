 ...
 *
 * F&O segment is fully wired to the live lifecycle hook on the API
 * server: every option signal that crosses its trigger AND clears
 * the confidence + daily-cap floor opens a row here automatically.
 * Equity segment is intentionally a placeholder until Phase 3 ships
 * — wiring it to STRONG_BUY signals requires equity-side trade
 * lifecycle work that is not part of this release.
 */
...
function EquityPlaceholder() {
  return (
    <Card>
      <CardHeader>
        <CardTitle>Equity paper trading — coming next</CardTitle>
        <CardDescription>
          Phase 3 of the paper trading roll-out. Will auto-trade STRONG_BUY
          signals with confidence ≥ 70 and reward-to-risk ≥ 1.5 against a
          ₹10,00,000 bankroll that auto-refills daily. Exits on target,
          stop, or manual close — never on a reversal signal.
        </CardDescription>
      </CardHeader>
    </Card>
  );
