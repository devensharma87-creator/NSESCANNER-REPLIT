...
const TOPICS: Topic[] = [
  ...
  },
  {
    ...
    keyConcepts: [
      ...
      { term: "Candlestick Patterns (the 12 you need)", desc: "Reversal: pin bar/hammer, shooting star, bullish/bearish engulfing, morning/evening star, tweezer top/bottom, three white soldiers/three black crows. Continuation: doji at S/R, inside bar, three-method (rising/falling). One-bar patterns are weakest; three-bar are strongest. ALL candle patterns require context — a hammer at random price = noise; a hammer at confluence S/R + RSI<30 = high-probability long." },
