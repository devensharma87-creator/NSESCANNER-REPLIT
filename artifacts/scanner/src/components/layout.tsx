...
import { ContainmentBanner } from "@/components/containment-banner";
              ...
              const entries: NavEntry[] = [
                ...
                },
                {
                  ...
                  items: [
                    ...
                    { href: "/directional-scorer", label: "Market Mood", desc: "NIFTY · BANKNIFTY · SENSEX bias at a glance", isActive: l => l.startsWith("/directional-scorer"), tab: "DIRECTIONAL_SCORER" },
