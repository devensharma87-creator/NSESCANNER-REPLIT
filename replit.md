...
- **Subscriber accounts (Rs 5500/year, manual owner verification)**:
  ...
  - 10 subscriber-grantable tab keys: HOME, SCANNER, OPTION_CHAIN, OI_LAB, WATCHLIST, PREMARKET, FLOWS, STOCKS_TO_WATCH, NEWS, LEARN. Mirrored in frontend `lib/tab-access.ts` — keep in sync.
