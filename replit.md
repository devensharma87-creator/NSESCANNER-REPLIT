...
- **Home Tab**: Revamped Home tab with data-rich layout: Global Cues strip (GIFT Nifty, Dow, S&P, Nasdaq, USD/INR, Brent, Gold, VIX, DXY, US10Y), FII/DII net + India VIX + Expiry countdown sentiment bar, Sectoral Heatmap (color-coded sector blocks), Market Breadth bar (A/D ratio), Tabbed Indian Indices hero section (4 mini-cards with sparklines and bias badges → expandable panel showing OHLC, EMAs, VWAP, Market Profile, CPR+PDH/PDL, Momentum Cluster (RSI/ADX/MACD/Vol Ratio), Options Layer (PCR/Max Pain/ATM IV/CE-PE walls), Floor Pivots ladder), Market Take auto-narrative, TrendCard + Market Mood gauge, Top Gainers/Losers, Top Bullish/Bearish Setups, collapsible full IndicesBoard, and scanner CTA. Backend enrichment at `/api/home/enrichment` returns per-index sparklines, momentum indicators, and options summary with 30s cache.
