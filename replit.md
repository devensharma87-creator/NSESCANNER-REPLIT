...
- **Strict scope**: NO changes to trading/F&O/paper-exec/stop-target-sizing/scanner-scoring/Kite-auth/scheduler. Tests: `returnLabel/risk/allocation/holdingPeriod/benchmark/persistence.test.ts` (466/466 scanner, 812/812 api-server, full typecheck green). **Not published** — owner to deploy when ready.
